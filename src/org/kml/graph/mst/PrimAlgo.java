...
public class PrimAlgo {
    ...
    public static void main(String[] args) {
        ...
        // Creating instance of PrimAlgo class
        PrimAlgo sol = new PrimAlgo();
    ...
    /*
    private List<List<int[]>> buildAdjacencyList(int N, List<List<List<Integer>>> edges)
    {
        ...
        for(List<List<Integer>> edge: edges)
        {
